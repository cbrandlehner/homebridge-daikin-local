...
//  this.targetHeatingCoolingState = Characteristic.TargetHeatingCoolingState.AUTO;
  ...
  this.econoModeService = new Service.Switch('Econo Mode', 'econo');
  this.powerfulModeService = new Service.Switch('Powerful Mode', 'powerful');
  this.nightQuietModeService = new Service.Switch('Night Quiet', 'quiet');
